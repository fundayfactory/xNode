...
namespace XNodeEditor {
    public partial class NodeEditorWindow {
        ...
        public void Home() {
            List<Node> nodes = Selection.objects.Where(o => o is XNode.Node).Cast<XNode.Node>().ToList();
            if (nodes.Count == 0) nodes = graph.nodes;
        ...
        public void DrawDraggedConnection() {
            if (IsDraggingPort) {
                ...
                INoodleDrawer drawer = graphEditor.GetNoodleDrawer(draggedOutput, null);
                ...
                DrawNoodle(draggedOutput, null, gradient, drawer, stroke, thickness, gridPoints);
